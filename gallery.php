...
<head>
    ...
    <link rel="stylesheet" href="/whitemanBLACK/CSS/fonts.css">
...
<!-- Sidebar Navigation -->
    <aside class="w-64 bg-stone-900 text-white min-h-screen p-6">
        ...
        <ul>
            <li class="mt-3"><a href="Admin_dashboard.php" class="transition duration-300 ease-in-out hover:bg-yellow-700 text-xl block rounded">Home</a></li>
            <li class="mt-6"><a href="Company_mission.php" class="transition duration-300 ease-in-out hover:bg-yellow-700 text-xl block rounded">Our Mission</a></li>
            <li class="mt-6"><a href="Company_vision.php" class="transition duration-300 ease-in-out hover:bg-yellow-700 text-xl block rounded">Our Vision</a></li>
            <li class="mt-6"><a href="Company_goal.php" class="transition duration-300 ease-in-out hover:bg-yellow-700 text-xl block rounded">Our Goal</a></li>
